...
public interface ChamadoRepository extends JpaRepository<Chamado, Integer> {
    ...
    List<Chamado> findByCliente(Cliente cliente); // Filtrar os chamados de um cliente especifico
    List<Chamado> findByFuncionario(Funcionario funcionario);// Filtrar os chamados de um funcionario especifico
    // usa @Query usando sql                                                                 //(:Parametro)
