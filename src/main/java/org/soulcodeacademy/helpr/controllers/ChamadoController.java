...
public class ChamadoController {
    ...
    @PostMapping("/chamados/{idChamado}")
    ...
    public List<Chamado> listaPorIntervaloDatas(@RequestParam @DateTimeFormat(iso= DateTimeFormat.ISO.DATE) LocalDate inicio, @RequestParam @DateTimeFormat(iso=DateTimeFormat.ISO.DATE)LocalDate fim){
